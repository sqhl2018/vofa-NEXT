...
export const ProtocolNode = memo(function ProtocolNode({ id, data }: NodeProps) {
  ...
  return (
    <CanvasErrorTooltip message={errorMessage}>
      ...
      >
      <div className="node-drag-handle flex items-center justify-between px-1.5 py-1 border-b border-border text-[10px] font-semibold uppercase tracking-[0.4px] text-accent cursor-grab active:cursor-grabbing">
